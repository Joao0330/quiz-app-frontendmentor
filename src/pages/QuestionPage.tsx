		...
		<section className='min-h-screen px-6 md:px-16 xl:px-0 xl:pr-35.75 xl:pl-35'>
			...
			<div className='pt-8 pb-21.75 flex flex-col gap-10 md:pt-0 xl:flex-row xl:items-start xl:gap-32'>
				<div className='xl:min-w-116.25'>
					<p className='text-preset5-mobile text-grey-500 md:text-preset6'>
						Question <span>6</span> of <span>10</span>
					</p>

					<h2 className='mt-4 mb-6 text-preset3-mobile text-blue-900 md:text-preset3 md:mt-6 md:mb-10 xl:mb-46'>
				...
				{/* TODO: Make dark mode styles, add hover/active effects to the components */}
			</div>
		</section>
	);
};
